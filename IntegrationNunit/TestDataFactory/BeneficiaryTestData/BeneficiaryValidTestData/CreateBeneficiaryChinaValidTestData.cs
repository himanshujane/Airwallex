...
{
    public class CreateBeneficiaryChinaValidTestData : IEnumerable
    {
        public IEnumerator GetEnumerator()
        {
            ...
            yield return new CreateBeneficiaryRequestDto[]
            {
                new()
                {
                    TestcaseName = "CN Account Number Length is 14",
            ...
            yield return new CreateBeneficiaryRequestDto[]
            {
                new()
                {
                    TestcaseName = "CN Account Number Length is 20",
