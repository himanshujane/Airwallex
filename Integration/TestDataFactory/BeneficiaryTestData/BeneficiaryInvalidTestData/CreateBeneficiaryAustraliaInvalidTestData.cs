...
using Xunit.Sdk;
using static Tests.TestDataFactory.BeneficiaryTestData.BeneficiaryValidTestData.CreateBeneficiaryAustraliaValidTestData;

namespace Tests.TestDataFactory.BeneficiaryTestData.BeneficiaryInvalidTestData
{
    public class CreateBeneficiaryAustraliaInvalidTestData : DataAttribute
    {
        public override IEnumerable<CreateBeneficiaryRequestDto[]> GetData(MethodInfo testMethod)
        {
            ...
            yield return new CreateBeneficiaryRequestDto[]
            {
                new()
                {
                    _TestName = "AU Account Number Greater Than 20",
            ...
            yield return new CreateBeneficiaryRequestDto[]
            {
                new()
                {
                    _TestName = "AU Account Number Less Than 6",
            ...
            yield return new CreateBeneficiaryRequestDto[]
            {
                new()
                {
                    _TestName = "AU Account Number Empty",
            ...
            yield return new CreateBeneficiaryRequestDto[]
            {
                new()
                {
                    _TestName = "AU Account Number Null",
            ...
            yield return new CreateBeneficiaryRequestDto[]
            {
                new()
                {
                    _TestName = "AU Account Routing Type Invalid [aba]",
            ...
            yield return new CreateBeneficiaryRequestDto[]
            {
                new()
                {
                    _TestName = "AU Account Routing Type Null",
            ...
            yield return new CreateBeneficiaryRequestDto[]
            {
                new()
                {
                    _TestName = "AU Account Routing Type Empty",
            ...
            yield return new CreateBeneficiaryRequestDto[]
            {
                new()
                {
                    _TestName = "AU Account Routing Type Value Less Than 6 Char",
            ...
            yield return new CreateBeneficiaryRequestDto[]
            {
                new()
                {
                    _TestName = "AU Account Routing Type Value Greater Than 6 Char",
